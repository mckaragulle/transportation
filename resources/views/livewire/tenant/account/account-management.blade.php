        ...
        <div class="card-body">
            ...
            <div class="custom-tab-1">
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#addresses"><i class="la la-envelope me-2"></i> Adreslerim</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="home1" role="tabpanel">
                        <div class="pt-4">
                            <livewire:tenant.account.account-edit id="{{$account->id}}" is_show="0" />
                        </div>
                    </div>
                    <div class="tab-pane fade" id="addresses">
                        <div class="pt-4">
                            <livewire:tenant.account-address.account-addresses id="{{$account->id}}" is_show="0" />
                        </div>
                    </div>
                    <div class="tab-pane fade" id="banks">
                        <div class="pt-4">
                            <livewire:tenant.account-bank.account-banks id="{{$account->id}}" is_show="0" />
                        </div>
                    </div>
                    <div class="tab-pane fade" id="officers">
                        <div class="pt-4">
                            <livewire:tenant.account-officer.account-officers id="{{$account->id}}" is_show="0" />
                        </div>
                    </div>
                    <div class="tab-pane fade" id="files">
                        <div class="pt-4">
                            <livewire:tenant.account-file.account-files id="{{$account->id}}" is_show="0" />
                        </div>
                    </div>
