...
class AccountEdit extends Component
{
    ...
    public null|array|Collection $account_types = [];
    ...
    public function mount($id = null, LandlordAccountTypeCategory $accountTypeCategory, LandlordAccountService $accountService, bool $is_show = true)
    {
        if (!is_null($id)) {
    ...
    {
        return view('livewire.landlord.account.account-edit');
    }
    ...
    {
        $this->account_types = LandlordAccountType::query()
