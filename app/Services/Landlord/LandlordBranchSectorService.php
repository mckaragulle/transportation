...
use App\Repositories\Landlord\LandlordbranchesectorRepository;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Support\Collection;

class LandlordbranchesectorService
{
    public function __construct(protected LandlordbranchesectorRepository $repository) {}
