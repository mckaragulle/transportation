...
use App\Repositories\Landlord\LandlordDealerRepository;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Support\Collection;

class LandlordDealerService
{
    public function __construct(protected LandlordDealerRepository $repository) {}
