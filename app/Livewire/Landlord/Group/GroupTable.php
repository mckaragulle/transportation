...
final class GroupTable extends PowerGridComponent
{
    ...
    public function filters(): array
    {
        ...
        return [
            ...
            Filter::select('group_id')
                ->dataSource(LandlordGroup::orderBy('id', 'asc')->get())
                ->optionLabel('name')
                ->optionValue('id'),
    ...
    public function actions(LandlordGroup $row): array
    {
        return [
            Button::add('view')
    ...
    {
        LandlordGroup::query()->find($id)->update([
            $field => e($value) ? 1 : 0,
        ]);
    }
