<div class="col-xl-12">
    ...
    <div class="row page-titles">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('tenant.dealer_logos.list') }}">Bayi Logoları</a></li>
    ...
    <div class="card overflow-hidden">
        ...
        <div class="card-header border-bottom border-warning warning">
            <h4 class="card-title mb-0">Bayi Logosu Oluştur</h4>
        </div>
        @endif
                ...
                <form wire:submit.prevent="store">
                    <div class="row">
                        <div class="col-lg-12 col-sm-12">
                            ...
                            <div class="mb-3 row">
                                <div class="col-sm-2">
                                    <label class="col-form-label">Logo adını yazınız:</label>
                                    <input class="form-control" type="text" required wire:model.defer="title"
                                        placeholder="Logo adını yazınız.">
                                    @error('title')
                                        <div class="alert alert-danger alert-dismissible alert-alt solid fade show">
                                            <button type="button" class="btn-close" data-bs-dismiss="alert"
                                                aria-label="btn-close">
                                ...
                                <div class="col-sm-3">
                                    <label class="col-form-label">Logo seçiniz:</label>
