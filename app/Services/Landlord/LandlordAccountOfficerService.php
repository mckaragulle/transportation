...
use App\Repositories\Landlord\LandlordAccountOfficerRepository;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Support\Collection;

class LandlordAccountOfficerService
{
    public function __construct(protected LandlordAccountOfficerRepository $repository) {}
