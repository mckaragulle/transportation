...
final class AccountTypeCategoryTable extends PowerGridComponent
{
    ...
    public function setUp(): array
    {
        ...
        return [
            PowerGrid::exportable(fileName: 'cari-kategorileri')
                ->striped()
    ...
    {
        return LandlordAccountTypeCategory::query();
    }
    ...
    public function actions(LandlordAccountTypeCategory $row): array
    {
        return [
            Button::add('view')
    ...
    {
        LandlordAccountTypeCategory::query()->find($id)->update([
            $field => e($value) ? 1 : 0,
        ]);
    }
