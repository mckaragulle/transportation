...
use App\Repositories\Landlord\LandlordAccountFileRepository;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Support\Collection;

class LandlordAccountFileService
{
    public function __construct(protected LandlordAccountFileRepository $repository) {}
