...
use App\Repositories\Landlord\LandlordDealerTypeCategoryRepository;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Support\Collection;

class LandlordDealerTypeCategoryService
{
    public function __construct(protected LandlordDealerTypeCategoryRepository $repository) {}
