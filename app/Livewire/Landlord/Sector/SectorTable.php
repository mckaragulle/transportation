...
final class SectorTable extends PowerGridComponent
{
    ...
    public function filters(): array
    {
        ...
        return [
            ...
            Filter::select('sector_id')
                ->dataSource(LandlordSector::orderBy('id', 'asc')->get())
                ->optionLabel('name')
                ->optionValue('id'),
    ...
    public function actions(LandlordSector $row): array
    {
        return [
            Button::add('view')
    ...
    {
        LandlordSector::query()->find($id)->update([
            $field => e($value) ? 1 : 0,
        ]);
    }
