<div class="col-xl-12">
    <div class="row page-titles">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('tenant.account_addresses.list') }}">Cari Adresleri</a></li>
            <li class="breadcrumb-item active"><a href="javascript:void(0)">Düzenle</a></li>
        </ol>
    </div>
    <div class="card overflow-hidden">
        <div class="card-header border-bottom border-warning warning">
            <h4 class="card-title mb-0">Cari Adresi Düzenle</h4>
        </div>
        <div class="card-body">
                            ...
                            <div class="mb-3 row">
                                <div class="col-sm-2">
                                    ...
                                    <input class="form-control" type="text" required wire:model.defer="name"
                                        placeholder="Cari adres başlığını yazınız.">
                                    @error('name')
                                        <div class="alert alert-danger alert-dismissible alert-alt solid fade show">
                                            <button type="button" class="btn-close" data-bs-dismiss="alert"
                                                aria-label="btn-close">
