...
use App\Repositories\Tenant\BranchTypeCategoryRepository;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Support\Collection;

class BranchTypeCategoryService
{
    public function __construct(protected BranchTypeCategoryRepository $repository) {}
