<div class="col-xl-12">
    <div class="row page-titles">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{route('neighborhoods.list')}}">Mahalleler</a></li>
            <li class="breadcrumb-item active"><a href="javascript:void(0)">Düzenle</a></li>
        </ol>
    </div>
    <div class="card overflow-hidden">
        <div class="card-header border-bottom border-warning warning">
            <h4 class="card-title mb-0">Mahalle Düzenle</h4>
        </div>
        <div class="card-body">
                ...
                <form wire:submit.prevent="update">
                    <div class="row">
                        <div class="col-lg-12 col-sm-12">
                            ...
                            @endif
                            <div class="mb-3 row">
                                <label class="col-sm-3 col-form-label">Mahalle adını yazınız:</label>
                                <div class="col-sm-3">
                            ...
                            <div class="mb-3 row">
                                <label class="col-sm-3 col-form-label">Posta kodunu yazınız:</label>
                                <div class="col-sm-3">
                                    <input class="form-control" type="text" wire:model.defer="postcode"
