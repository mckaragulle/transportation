<div class="col-xl-12">
    <div class="row page-titles">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{route('vehicle_property_categories.list')}}">Araç Markaları</a></li>
    ...
    <div class="card overflow-hidden border border-warning">
        <div class="card-header border-bottom border-warning warning">
            <h4 class="card-title mb-0">Araç Özellik Kategorisi Oluştur</h4>
        </div>
        <div class="card-body">
                ...
                <form wire:submit.prevent="store">
                    <div class="row">
                        <div class="col-lg-4 col-sm-12">
                            ...
                            <div class="mb-3 row">
                                <label class="col-sm-3 col-form-label">Araç özellik kategorisini yazınız :</label>
                                <div class="col-sm-9">
                                    <input class="form-control border border-warning" type="text"
                                        wire:model.defer="name" placeholder="Araç özellik kategorisini yazınız.">
                                    @error('name')
                                    <div class="alert alert-danger alert-dismissible alert-alt solid fade show">
                                        <button type="button" class="btn-close" data-bs-dismiss="alert"
                                            aria-label="btn-close">
