...
use App\Repositories\Landlord\LandlordAccountAddressRepository;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Support\Collection;

class LandlordAccountAddressService
{
    public function __construct(protected LandlordAccountAddressRepository $repository) {}
