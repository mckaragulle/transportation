<div class="col-xl-12">
    ...
    <div class="row page-titles">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('tenant.staff_addresses.list') }}">Personel Adresleri</a></li>
    ...
    <div class="card overflow-hidden">
        ...
        <div class="card-header border-bottom border-warning warning">
            <h4 class="card-title mb-0">Personel Adresi Oluştur</h4>
        </div>
        @endif
                ...
                <form wire:submit.prevent="store">
                    <div class="row">
                        ...
                        <hr />
                            ...
                            <div class="mb-3 row">
                                <div class="col-sm-2">
                                    <label class="col-form-label">Personel adres başlığını yazınız:</label>
                                    <input class="form-control" type="text" required wire:model.defer="name"
                                        placeholder="Personel adres başlığını yazınız.">
                                    @error('name')
                                        <div class="alert alert-danger alert-dismissible alert-alt solid fade show">
                                            <button type="button" class="btn-close" data-bs-dismiss="alert"
                                                aria-label="btn-close">
