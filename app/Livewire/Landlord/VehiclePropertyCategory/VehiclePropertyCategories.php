...
class VehiclePropertyCategories extends Component
{
    ...
    {
        return view('livewire.landlord.vehicle-property-category.vehicle-property-categories');
    }
    ...
    #[On('handleConfirmed')]
    public function handleConfirmed(LandlordVehiclePropertyCategoryService $VehiclePropertyCategoryService)
    {
        try {
