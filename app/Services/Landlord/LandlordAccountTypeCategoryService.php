...
use App\Repositories\Landlord\LandlordAccountTypeCategoryRepository;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Support\Collection;

class LandlordAccountTypeCategoryService
{
    public function __construct(protected LandlordAccountTypeCategoryRepository $repository) {}
