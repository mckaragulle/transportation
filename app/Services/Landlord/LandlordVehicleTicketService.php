...
use App\Repositories\Landlord\LandlordVehicleTicketRepository;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Support\Collection;

class LandlordVehicleTicketService
{
    public function __construct(protected LandlordVehicleTicketRepository $repository) {}
