...
use App\Repositories\Landlord\LandlordVehicleModelRepository;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Support\Collection;

class LandlordVehicleModelService
{
    public function __construct(protected LandlordVehicleModelRepository $repository) {}
