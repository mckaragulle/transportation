...
use App\Repositories\Landlord\LandlordHgsTypeCategoryRepository;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Support\Collection;

class LandlordHgsTypeCategoryService
{
    public function __construct(protected LandlordHgsTypeCategoryRepository $repository) {}
