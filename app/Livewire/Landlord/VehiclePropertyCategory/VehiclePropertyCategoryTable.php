...
final class VehiclePropertyCategoryTable extends PowerGridComponent
{
    ...
    public function setUp(): array
    {
        ...
        return [
            PowerGrid::exportable(fileName: 'arac-ozellik-kategorileri')
                ->striped()
    ...
    {
        return LandlordVehiclePropertyCategory::query();
    }
    ...
    public function actions(LandlordVehiclePropertyCategory $row): array
    {
        return [
            Button::add('view')
    ...
    {
        LandlordVehiclePropertyCategory::query()->find($id)->update([
            $field => e($value) ? 1 : 0,
        ]);
    }
