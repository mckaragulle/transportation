...
use App\Repositories\Landlord\LandlordLocalityRepository;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Support\Collection;

class LandlordLocalityService
{
    public function __construct(protected LandlordLocalityRepository $repository) {}
