...
use App\Repositories\Landlord\LandlordDealerBankRepository;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Support\Collection;

class LandlordDealerBankService
{
    public function __construct(protected LandlordDealerBankRepository $repository) {}
