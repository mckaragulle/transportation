...
class GroupEdit extends Component
{
    ...
    protected LandlordGroupService $groupService;
    ...
    public function mount($id = null, LandlordGroupService $groupService)
    {
        if (!is_null($id)) {
            ...
            $this->groups = LandlordGroup::query()
            ->whereNull('group_id')
            ->orderBy('id')
    ...
    {
        return view('livewire.landlord.group.group-edit');
    }
