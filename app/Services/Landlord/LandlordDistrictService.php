...
use App\Repositories\Landlord\LandlordDistrictRepository;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Support\Collection;

class LandlordDistrictService
{
    public function __construct(protected LandlordDistrictRepository $repository) {}
