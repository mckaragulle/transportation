...
final class NeighborhoodTable extends PowerGridComponent
{
    ...
    {
        return LandlordNeighborhood::query();
    }
    ...
    public function filters(): array
    {
        ...
        $query = LandlordNeighborhood::query();
        if ($city_id > 0) {
    ...
    public function actions(LandlordNeighborhood $row): array
    {
        return [
            Button::add('view')
    ...
    {
        LandlordNeighborhood::query()->find($id)->update([
            $field => e($value) ? 1 : 0,
        ]);
        $this->skipRender();
    }
