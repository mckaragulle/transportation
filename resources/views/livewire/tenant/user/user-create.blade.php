<div class="col-xl-12">
    <div class="row page-titles">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{route('tenant.users.list')}}">Personeller</a></li>
    ...
    <div class="card overflow-hidden border border-warning">
        <div class="card-header border-bottom border-warning warning">
            <h4 class="card-title mb-0">Personel Oluştur</h4>
        </div>
        <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-sm-12">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <select id="department_id" wire:model="role" class="form-select form-select-lg">
                        ...
                        <div class="col-lg-4 col-sm-12">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control border border-warning" type="text" wire:model.defer="phone" placeholder="Telefon yazınız.">
                                    @error('phone')
                                    <div class="alert alert-danger alert-dismissible alert-alt solid fade show">
                                        <button type="button" class="btn-close" data-bs-dismiss="alert"
                                                aria-label="btn-close">
