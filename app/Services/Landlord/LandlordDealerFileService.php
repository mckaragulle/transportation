...
use App\Repositories\Landlord\LandlordDealerFileRepository;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Support\Collection;

class LandlordDealerFileService
{
    public function __construct(protected LandlordDealerFileRepository $repository) {}
