...
use App\Repositories\Landlord\LandlordDealerAddressRepository;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Support\Collection;

class LandlordDealerAddressService
{
    public function __construct(protected LandlordDealerAddressRepository $repository) {}
