...
use App\Repositories\Landlord\LandlordBranchTypeCategoryRepository;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Support\Collection;

class LandlordBranchTypeCategoryService
{
    public function __construct(protected LandlordBranchTypeCategoryRepository $repository) {}
