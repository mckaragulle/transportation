...
use App\Repositories\Landlord\LandlordStaffTypeRepository;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Support\Collection;

class LandlordStaffTypeService
{
    public function __construct(protected LandlordStaffTypeRepository $repository) {}
