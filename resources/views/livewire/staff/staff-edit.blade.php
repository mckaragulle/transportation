                    ...
                    <div class="row">
                        <div class="col-lg-12 col-sm-12">
                                ...
                                <div class="mb-3 row">
                                    @foreach ($staffTypeCategoryDatas as $staffTypeCategory)
                                        <div class="col-lg-2 col-sm-12">
                                            <label class="col-form-label">{{ $staffTypeCategory->name }} SEÇİNİZ :</label>
                                                ...
                                                @if (is_iterable($staffTypeCategory->staff_types))
                                                    @forelse($staffTypeCategory->staff_types as $staffType)
                                                        @if (count($staffType->staff_types) == 0)
                                                            <option value="{{ $staffType->id }}" {{in_array($staffType->id, $staff_types)? 'selected':''}}>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-2">
                                    <label class="col-form-label">Personel emailini yazınız:</label>
                                    <input class="form-control" type="text" wire:model.defer="email"
                                        placeholder="Personel emailini yazınız.">
                                    @error('email')
                                        <div class="alert alert-danger alert-dismissible alert-alt solid fade show">
                                            <button type="button" class="btn-close" data-bs-dismiss="alert"
                                                aria-label="btn-close">
