...
use App\Repositories\Landlord\LandlordDealerLogoRepository;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Support\Collection;

class LandlordDealerLogoService
{
    public function __construct(protected LandlordDealerLogoRepository $repository) {}
