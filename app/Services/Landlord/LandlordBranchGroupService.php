...
use App\Repositories\Landlord\LandlordBranchGroupRepository;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Support\Collection;

class LandlordBranchGroupService
{
    public function __construct(protected LandlordBranchGroupRepository $repository) {}
