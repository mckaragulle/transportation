...
use App\Repositories\Landlord\LandlordVehicleBrandRepository;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Support\Collection;

class LandlordVehicleBrandService
{
    public function __construct(protected LandlordVehicleBrandRepository $repository) {}
