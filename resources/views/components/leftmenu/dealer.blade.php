<li>
    ...
    <ul aria-expanded="false" class="mm-collapse left" style="">
                ...
                @can('read accounts')
                    <li>
                        <a class="dropdown-item ai-icon fs-6 py-1 btn-sm"
                            href="{{ route('tenant.accounts.list') }}"><i
        ...
        @can('read licences')
            <li>
                <a href="{{ route('tenant.licences.list') }}" aria-expanded="false">
        ...
        <li>
            ...
            <ul aria-expanded="false" class="mm-collapse left" style="">
                @can('read hgses')
                    <li>
                        <a class="dropdown-item ai-icon fs-6 py-1 btn-sm"
                            href="{{ route('tenant.hgses.list') }}"><i
        ...
        <li>
            ...
            <ul aria-expanded="false" class="mm-collapse left" style="">
                @can('read staffs')
                    <li>
                        <a class="dropdown-item ai-icon fs-6 py-1 btn-sm"
                            href="{{ route('tenant.staffs.list') }}"><i
...
@can('read fineds')
    <li>
        <a href="{{ route('tenant.fineds.list') }}" aria-expanded="false">
            <i class="fas  fa-ticket"></i>
