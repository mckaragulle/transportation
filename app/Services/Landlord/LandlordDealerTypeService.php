...
use App\Repositories\Landlord\LandlordDealerTypeRepository;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Support\Collection;

class LandlordDealerTypeService
{
    public function __construct(protected LandlordDealerTypeRepository $repository) {}
