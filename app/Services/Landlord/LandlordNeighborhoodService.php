...
use App\Repositories\Landlord\LandlordNeighborhoodRepository;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Support\Collection;

class LandlordNeighborhoodService
{
    public function __construct(protected LandlordNeighborhoodRepository $repository) {}
