...
use App\Repositories\Landlord\LandlordAccountTypeRepository;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Support\Collection;

class LandlordAccountTypeService
{
    public function __construct(protected LandlordAccountTypeRepository $repository) {}
