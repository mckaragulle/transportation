...
use App\Repositories\Landlord\LandlordLicenceTypeRepository;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Support\Collection;

class LandlordLicenceTypeService
{
    public function __construct(protected LandlordLicenceTypeRepository $repository) {}
