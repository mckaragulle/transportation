...
use App\Repositories\Landlord\LandlordDealerOfficerRepository;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Support\Collection;

class LandlordDealerOfficerService
{
    public function __construct(protected LandlordDealerOfficerRepository $repository) {}
