            ...
            <div class="custom-tab-1">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="home1" role="tabpanel">
                        <div class="pt-4">
                            <livewire:tenant.dealer.dealer-edit id="{{$dealer->id}}" is_show="0" />
                            <div class="custom-tab-2">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="addresses">
                                        <div class="pt-4">
                                            <livewire:tenant.dealer-address.dealer-addresses id="{{$dealer->id}}" is_show="0" />
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="banks">
                                        <div class="pt-4">
                                            <livewire:tenant.dealer-bank.dealer-banks id="{{$dealer->id}}" is_show="0" />
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="officers">
                                        <div class="pt-4">
                                            <livewire:tenant.dealer-officer.dealer-officers id="{{$dealer->id}}" is_show="0" />
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="files">
                                        <div class="pt-4">
                                            <livewire:tenant.dealer-file.dealer-files id="{{$dealer->id}}" is_show="0" />
                                        </div>
                                    </div>
                    ...
                    <div class="tab-pane fade" id="home2" role="tabpanel">
                        <div class="pt-4">
                            <livewire:tenant.dealer.dealer-selections id="{{$dealer->id}}" />
                        </div>
                    </div>

                    <div class="tab-pane fade" id="logos" role="tabpanel">
                        <div class="pt-4">
                            <livewire:tenant.dealer-logo.dealer-logos id="{{$dealer->id}}" is_show="0" />
                        </div>
                    </div>
                </div>
            </div>
