...
class AccountCreate extends Component
{
    ...
    {
        return view('livewire.landlord.account.account-create');
    }

    public function mount(LandlordAccountTypeCategory $accountTypeCategory)
    {
     ...
     * @return void
     */
    public function store(LandlordAccountService $accountService)
    {
        $this->validate();
        DB::beginTransaction();
        try {
