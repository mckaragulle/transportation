...
final class AccountTable extends PowerGridComponent
{
    ...
    public function setUp(): array
    {
        ...
        $this->accountCategories = LandlordAccountTypeCategory::query()->with(['account_types'])->get(['id', 'name']);
    ...
    public function actions(LandlordAccount $row): array
    {
        return [
            Button::add('manage')
    ...
    {
        LandlordAccount::query()->find($id)->update([
            $field => e($value) ? 1 : 0,
        ]);
    }
