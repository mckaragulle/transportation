...
use App\Repositories\Landlord\LandlordVehiclePropertyCategoryRepository;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Support\Collection;

class LandlordVehiclePropertyCategoryService
{
    public function __construct(protected LandlordVehiclePropertyCategoryRepository $repository) {}
