...
use App\Repositories\Landlord\LandlordLicenceTypeCategoryRepository;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Support\Collection;

class LandlordLicenceTypeCategoryService
{
    public function __construct(protected LandlordLicenceTypeCategoryRepository $repository) {}
