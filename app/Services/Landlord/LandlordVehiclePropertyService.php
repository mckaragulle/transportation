...
use App\Repositories\Landlord\LandlordVehiclePropertyRepository;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Support\Collection;

class LandlordVehiclePropertyService
{
    public function __construct(protected LandlordVehiclePropertyRepository $repository) {}
