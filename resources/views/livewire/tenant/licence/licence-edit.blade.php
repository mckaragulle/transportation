<div class="col-xl-12">
    <div class="row page-titles">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('tenant.licences.list') }}">Sürücü Belgeleri</a></li>
            <li class="breadcrumb-item active"><a href="javascript:void(0)">Düzenle</a></li>
        </ol>
    </div>
    <div class="card overflow-hidden">
        <div class="card-header border-bottom border-warning warning">
            <h4 class="card-title mb-0">Sürücü Belgesi Düzenle</h4>
        </div>
        <div class="card-body">
                                                    ...
                                                    @forelse($licenceTypeCategory->licence_types as $licenceType)
                                                        @if (count($licenceType->licence_types) == 0)
                                                            <option value="{{ $licenceType->id }}"
                                                                {{ in_array($licenceType->id, $licence_types) ? 'selected' : '' }}>
